...
`)+`
`+u);const A=b+p+a,E=b+u+o,U=Ba(r,r.VERTEX_SHADER,A),w=Ba(r,r.FRAGMENT_SHADER,E);r.attachShader(S,U),r.attachShader(S,w),t.index0AttributeName!==void 0?r.bindAttribLocation(S,0,t.index0AttributeName):t.morphTargets===!0&&r.bindAttribLocation(S,0,"position"),r.linkProgram(S);function T(C){if(i.debug.checkShaderErrors){const N=r.getProgramInfoLog(S).trim(),F=r.getShaderInfoLog(U).trim(),W=r.getShaderInfoLog(w).trim();let K=!0,q=!0;if(r.getProgramParameter(S,r.LINK_STATUS)===!1)if(K=!1,typeof i.debug.onShaderError=="function")i.debug.onShaderError(r,S,U,w);else{const J=Ha(r,U,"vertex"),V=Ha(r,w,"fragment");console.error("THREE.WebGLProgram: Shader Error "+r.getError()+" - VALIDATE_STATUS "+r.getProgramParameter(S,r.VALIDATE_STATUS)+`
